...
#define LAY_BUFF5		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 6		// Used for Gif and keyboard cursor
#define LAY_BUFF6		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 7		// Used for Gif	and Keyboard key effect
#define LAY_BUFF7		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 8		// Used for switching pages and pop-up pages
#define LAY_BUFF8		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 9		// encoder and pop
#define LAY_BUFF9		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 10		// Used for circular progress bar
#define LAY_BUFF10		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 11		// 
#define LAY_BUFF11		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 12		// Used for point
#define LAY_BUFF12		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 13		// Used for Sld
#define LAY_BUFF15		LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 13		// Used for text scrolling(occupying two layers)
#define slideMune_BUFF	LCD_XSIZE_TFT * LCD_YSIZE_TFT * (2 + TFT_bitcolor) * 10		//
...
extern uint8_t UI_rotate;
extern uint32_t UI_rotate_addr;
