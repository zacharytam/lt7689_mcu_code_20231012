...
const UINT8 USB_cdc_Device_Descriptor[18] =   //USB设备描述符
{
	...
	0xEF, 0xEE,                 //idVendor:  厂商 ID
	0x8A, 0x26,                 //idProduct: 产品 ID
	0x00, 0x00,                 //bcdDevice: 设备版本
...
const UINT8 USB_cdc_Device_Qualifier_Descriptor[10] =
{
...
{                                 //USB配置描述符
	...
	0x01,                         //iInterface   该接口的字符串索引值。这里没有，为0。
    /***************以下为功能描述符****************/
	...
	0x00,						  //bmCapabilities字段。支持Set_Line_Coding、Set_Control_Line_State、Get_Line_Coding请求和Serial_State通知
	...
	0x00,0x02,					  //wMaxPacketSize字段。该端点的最大包长。512字节
	...
	0x00,0x02,					  //wMaxPacketSize字段。该端点的最大包长。端点2的最大包长为512字节。注意低字节在先。
...
//Manufacturer String
const UINT8 UsbStrDescManufacturer[20] =
{
	0x14,			//bLength
...
//Product String
const UINT8 UsbStrDescProduct[18] =
{
	0x12,			//bLength;
	0x03,		    //bDescriptorType
	'U',0x00,
...
//Serial Number
const UINT8 UsbStrDescSerialNumber[18] =
{
	0x12,		//bLength;
