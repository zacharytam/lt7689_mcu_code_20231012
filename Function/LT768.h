...
#define LCD_csH    SPI_WriteGpioData(SPI3, SPI_MOSI, 1)
#define LCD_csL    SPI_WriteGpioData(SPI3, SPI_MOSI, 0)
#define LCD_sclH   SPI_WriteGpioData(SPI3, SPI_MISO, 1)
#define LCD_sclL   SPI_WriteGpioData(SPI3, SPI_MISO, 0)
#define LCD_sdaH   EPORT_WriteGpioData(EPORT_PIN2, 1)
#define LCD_sdaL   EPORT_WriteGpioData(EPORT_PIN2, 0)
